...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        _playerInput.PlayerKeyboardInput.BEG.started += OnPlayerSprint;
        _playerInput.PlayerKeyboardInput.BEG.canceled += OnPlayerSprint;
    ...
    private void Rotate()
    {
        if (_movementVector.magnitude > 0)
        {
            ...
            Quaternion rotation = Quaternion.Lerp(transform.rotation, targetRotation, Time.deltaTime);
